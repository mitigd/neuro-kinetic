          ...
          <div className="max-w-6xl mx-auto w-full min-h-screen flex flex-col justify-center p-6 md:p-12 relative z-10">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-slate-200 mb-2 group-hover:text-emerald-400 transition-colors">
                  Neuro Saccade
                </h3>
                <p className="text-slate-500 text-sm mb-6 h-10 leading-relaxed">
                  Train <strong>Fluid Intelligence</strong> using a living, mutating cipher. Forces constant rule re-learning to separate logic from muscle memory.
                </p>
                <div className="flex items-center gap-2 text-xs font-mono text-slate-600">
                  <span className="px-2 py-1 bg-slate-800 rounded text-emerald-500/80">INFINITE FLOW</span>
                  <span className="px-2 py-1 bg-slate-800 rounded">ADAPTIVE RFT</span>
                </div>
              </button>
